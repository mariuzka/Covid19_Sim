...
# best_df8 = analyze_spotpy_output(8, "output_data/LHS_BW_2021_01_20.csv")
# best_df2 = analyze_spotpy_output(2, "output_data/LHS_HH_2021_01_22.csv")
# best_df10 = analyze_spotpy_output(10, "output_data/LHS_SAAR_2021_01_20.csv")
# best_df9 = analyze_spotpy_output(9, "output_data/LHS_BY_2020_01_14.csv")
